...
#ifndef PROVIDER_BASE1_SWIFT_H
#define PROVIDER_BASE1_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="provider_base1",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14provider_base111AppDelegate")
...
SWIFT_CLASS("_TtC14provider_base117MainFlutterWindow")

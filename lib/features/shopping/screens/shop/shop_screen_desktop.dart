...
import 'package:provider_base1/features/shopping/screens/shop/product_desktop.dart';
...
class ShopScreenDesktop extends StatefulWidget {
  const ShopScreenDesktop({super.key});

  @override
  State<ShopScreenDesktop> createState() => _ShopScreenDesktopState();
}

class _ShopScreenDesktopState extends State<ShopScreenDesktop> {
  @override
